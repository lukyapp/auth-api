...
@Injectable()
export class JwtAuthLocalStrategy extends PassportStrategy(
  Strategy,
  'jwt-local',
) {
  ...
  constructor(
    ...
    public readonly publicJwkGetterStrategy: LocalPublicJwkGetterStrategy,
  ) {
    const verifyOptions = {
    ...
    super({
      ...
      secretOrKeyProvider: (
        ...
        this.publicKeyGetter
          .get(this.publicJwkGetterStrategy, { rawJwt })
          .then((publicKey) => {
