 ...
 */
export type UnWrapLazyImport<Fn extends LazyImport<any>> = Awaited<
  ReturnType<Fn>
>['default'];
 ...
 */
export type NormalizeConstructor<T extends Constructor<any>> = Omit<
  T,
  'constructor'
> & {
...
export type ExtractFunctions<T, IgnoreList extends keyof T = never> = {
  [P in keyof T]: P extends IgnoreList
    ? never
